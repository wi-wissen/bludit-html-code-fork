...
class pluginHTMLCodeFork extends Plugin {
	...
	public function form()
	{
		...
		$html .= '<div>';
		$html .= '<label>Page Beginn Index</label>';
		$html .= '<textarea name="pageBeginHome" id="jspageBeginHome">'.$this->getValue('pageBeginHome').'</textarea>';
		$html .= '<span class="tip">'.$L->get('insert-code-in-the-page-at-the-top').'</span>';
		$html .= '</div>';
	...
	public function pageBegin()
	{
		...
		if ($WHERE_AM_I != 'page') {
			return html_entity_decode($this->getValue('pageBeginHome'));
		}
	}
